              ...
              {data2.map((item, index) => (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    borderWidth: 1,
                    borderColor:
                      selectedRadio2 === index ? '#1BBFA0' : '#DEF2ED',
                    borderRadius: 8,
                    marginVertical: 5,
                    paddingHorizontal: 10,
                  }}>
              ...
              {data3.map((item, index) => (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    borderWidth: 1,
                    borderColor:
                      selectedRadio3 === index ? '#1BBFA0' : '#DEF2ED',
                    borderRadius: 8,
                    marginVertical: 5,
                    paddingHorizontal: 10,
                  }}>
